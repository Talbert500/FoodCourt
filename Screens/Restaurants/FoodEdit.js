...
import { ImageBackground, Alert, RefreshControl, TextInput, Dimensions, TouchableWithoutFeedback, Keyboard, Platform, KeyboardAvoidingView, ActivityIndicator, Text, View, SafeAreaView, FlatList, TouchableOpacity, Image } from 'react-native';
...
function FoodEdit({ route, navigation }) {
  ...
  const [savingload,setSaving]=useState(false);
  ...
  const editPhoto = async (imagee) => {
    const getImageRef = tef(storage, 'foodImages/' + restName + "/" + foodId); //how the image will be addressed inside the storage
      ...
      <View style={{ paddingTop: 20, margin: 10, flexDirection: 'row', justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          {!loading ?
            (
              <View style={styles.shadowProp}>
                ...
                <Button onPress={openImagePickerAsync} buttonStyle={[styles.button, { backgroundColor: restaurantColor, maxWidth: 200 }]} titleStyle={styles.buttonTitle} title="Edit Photo" />
              </View>
            ) : (
        ...
        <View style={{ margin: 10, flex: 1, maxWidth: 600, minWidth: 300 }}>
          <View style={{ flexDirection: 'row' }}>
            <View>
              <Text style={{ fontFamily: 'Bold',fontSize:20 }}>Name:</Text>
              <TextInput
                style={[styles.inputContainer, { padding: 10, alignSelf: 'center', maxWidth: 250 }]}
          ...
          <Text style={{ fontFamily: 'Bold', fontSize: 20 }}>Price:</Text>
          <TextInput
            style={[styles.inputContainer, { padding: 10, alignSelf: 'left', maxWidth: 250 }]}
          ...
          <View>
            <Text style={{ marginVertical: 10, fontSize: 18 }}>{eatagain} % would eat again</Text>
              ...
              <Button onPress={saveChanges} buttonStyle={[styles.button, { backgroundColor: restaurantColor, maxWidth: 200 }]} titleStyle={styles.buttonTitle} title="Save Changes"/>
              {savingload?
              <Text style={{color:"orange"}}> Data saved </Text>:
               <></> }
