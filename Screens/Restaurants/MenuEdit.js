                    ...
                    <LinearGradient
                        ...
                        <View style={{ width: "100%", maxWidth: 700, flex: 1, alignSelf: 'center' }}>
                            <View style={{
                                ...
                                <Text ellipsizeMode='tail' numberOfLines={2} style={[styles.headerText, { color: "#D36E6E" }]}>{searchedRestaurant} </Text>
                                <Text style={{ color: "white", fontWeight: "bold" }}>Edit Mode</Text>
